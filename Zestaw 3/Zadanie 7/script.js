...
async function getG(data){
    ...
    if (all == over) {
        document.getElementById("g-answer").textContent = "Wszytkie miasta są powyżej 5k w pomorskim i jest ich: " + all;
    } else {
        document.getElementById("g-answer2").textContent = "Nie wszytskie miasta są powyżej 5k, tych poniżej jest: " + (all-over) + ", a tych powyżej: "+over;
    }
    }
